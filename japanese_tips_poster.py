...
def main():
    ...
    prompt = (
        ...
        f"{history_str}\n\n"
        "【เงื่อนไขสำคัญ - ต้องสั้นกระชับมาก ห้ามเกิน 140 ตัวอักษร】\n"
        "1. อธิบายเป็นภาษาไทยสั้นกระชับที่สุด เพื่อให้ความยาวรวม (รวมแฮชแท็กและลิงก์) ไม่เกิน 140 ตัวอักษรเด็ดขาด\n"
        "2. เลือกหัวข้อระดับเริ่มต้นมากๆ ที่ไม่ซ้ำกับรายการด้านบน (คำศัพท์เดี่ยวๆ หรือวลีทักทายสั้นๆ)\n"
        "3. ห้ามใช้ตัวหนาแบบ Markdown (ห้ามใส่ **) ให้ใช้ข้อความธรรมดาเท่านั้น\n"
        "4. ลงท้ายด้วยแฮชแท็ก #เรียนภาษาญี่ปุ่น #ภาษาญี่ปุ่น และต่อท้ายด้วยลิงก์เว็บไซต์ yui-yuto.com เสมอ\n"
        "5. ในบรรทัดแรกสุดของข้อความที่ส่งกลับมา ให้พิมพ์คำว่า \"คีย์เวิร์ด: [คำศัพท์หรือคำภาษาญี่ปุ่นสั้นๆ 1 คำที่เลือก]\" เสมอ เพื่อตรวจสอบประวัติ\n\n"
        "【ตัวอย่างรูปแบบข้อความ (บังคับใช้รูปแบบสั้นนี้)】\n"
        "คีย์เวิร์ด: ねこ\n"
        "เรียนญี่ปุ่นง่ายๆ วันนี้เสนอคำว่า: ねこ (เนโกะ) = แมว\n"
        "ความหมาย: ใช้เรียกสัตว์เลี้ยงแมวทั่วไป\n"
